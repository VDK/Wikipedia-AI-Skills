...
| URL | `https://quickstatements.toolforge.org/` | `https://quickstatements3.toolforge.org/` (dev: `https://qs-dev.toolforge.org/`) |
...
1. **Web UI.** `quickstatements.toolforge.org` (QS 2) or
   `quickstatements3.toolforge.org` (QS 3). Log in with OAuth
...
3. **By URL.** Encode commands (newline -> `||`, then URL-encode) into:
   ...
   - QS 3.0: `https://quickstatements3.toolforge.org/batch/new?v1=...`
     (dev: `https://qs-dev.toolforge.org/batch/new?v1=...`)
